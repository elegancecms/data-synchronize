...
namespace EleganceCMS\DataSynchronize\Exporter;

use EleganceCMS\Base\Facades\Assets;
use EleganceCMS\Base\Facades\BaseHelper;
use EleganceCMS\DataSynchronize\Concerns\Exporter\HasEmptyState;
use EleganceCMS\DataSynchronize\Enums\ExportColumnType;
use Carbon\Carbon;
...
abstract class Exporter implements FromCollection, ShouldAutoSize, WithColumnFormatting, WithEvents, WithHeadings, WithMapping
{
    ...
    /**
     * @return \EleganceCMS\DataSynchronize\Exporter\ExportColumn[]
     */
    ...
    /**
     * @return \EleganceCMS\DataSynchronize\Exporter\ExportCounter[]
     */
